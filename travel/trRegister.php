<?php
  ...
  $sql1 = "SELECT * FROM truser WHERE username = '{$username}'";
  ...
  $sql2 = "INSERT INTO truser(username,number,worksp,password,create_time) VALUES('{$username}','{$number}','{$worksp}','{$str}','{$addTime}')";
